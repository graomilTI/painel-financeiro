(function(){
  ...
  const state={multas:[], motoristas:[], motoristasLoaded:false, busca:'', filtro:'abertas', arquivo:'ativas', sortKey:'vencimento', sortDir:'desc'};
  ...
  function openHome(container,opts={}){
    container.innerHTML=`${styles}<section class="fm-shell"><div class="fm-head"><div class="fm-kicker">Frotas · Notificações</div><h1 class="fm-title">Multas</h1><p class="fm-sub">Consulta, conferência, definição de motorista, identificação/dobra e arquivamento das multas recentes.</p></div><div class="fm-card"><div class="fm-tabs"><button class="fm-tab" data-open-excesso>Excesso de Velocidade</button><button class="fm-tab" data-open-veiculos>Veículos</button><button class="fm-tab active">Multas</button><button class="fm-tab" data-open-historico>Histórico</button></div><div class="fm-body"><div class="fm-toolbar"><select class="fm-select" data-filter><option value="abertas">Abertas / vencidas</option><option value="vencidas">Vencidas</option><option value="pagas">Pagas</option><option value="todas">Todas</option></select><select class="fm-select" data-archive-filter><option value="ativas">Multas ativas</option><option value="arquivadas">Consultar arquivadas</option><option value="todas">Ativas + arquivadas</option></select><input class="fm-input" data-search placeholder="Buscar por placa, motorista, auto, renavam, empresa..."><button class="fm-btn primary" data-refresh>Atualizar</button><button class="fm-btn primary" data-sync-multas>Sincronizar DETRAN</button></div><div class="fm-grid"><div class="fm-kpi"><span>Abertas</span><strong data-kpi-abertas>0</strong></div><div class="fm-kpi"><span>Vencidas</span><strong data-kpi-vencidas>0</strong></div><div class="fm-kpi"><span>Valor filtrado</span><strong data-kpi-valor>R$ 0,00</strong></div><div class="fm-kpi"><span>Guias/PDFs</span><strong data-kpi-guias>0</strong></div></div><p class="fm-sub" data-count>0 multa(s) encontrada(s)</p><div class="fm-table-wrap"><table class="fm-table"><thead><tr><th><button class="fm-sort" data-sort="placa" data-label="Placa / Empresa">Placa / Empresa</button></th><th><button class="fm-sort" data-sort="infracao" data-label="Infração">Infração</button></th><th><button class="fm-sort" data-sort="motorista" data-label="Motorista">Motorista</button></th><th><button class="fm-sort" data-sort="descricao" data-label="Descrição / Local">Descrição / Local</button></th><th><button class="fm-sort" data-sort="numero_auto_infracao" data-label="Auto">Auto</button></th><th><button class="fm-sort" data-sort="valor" data-label="Valor">Valor</button></th><th><button class="fm-sort" data-sort="vencimento" data-label="Vencimento">Vencimento</button></th><th><button class="fm-sort" data-sort="status" data-label="Status">Status</button></th><th>Ações</th></tr></thead><tbody data-multas-table></tbody></table></div><div class="fm-note">A lista exibe somente multas dos últimos <strong>180 dias</strong>, mantendo separadas a data da <strong>infração</strong> e a data de <strong>vencimento</strong>.</div></div></div></section>`;
