(function(){
  ...
  const state={multas:[], motoristas:[], motoristasLoaded:false, busca:'', filtro:'abertas', arquivo:'ativas', sortKey:'vencimento', sortDir:'desc', subTab:'todas'};
